...
def llm_call(state: AgentState):
    ...
    response = model_with_tools.invoke(
        [
            SystemMessage(
                content="You are a helpful assistant that solves arithmetic problem using tools when needed."
            )
        ]
        + state["messages"]
    )
...
#
# print("Most recent checkpoint id:",
...
result = agent.invoke(
    {
        "messages": [
            HumanMessage(content="Multiply 30 and 41.")
        ],
        "llm_calls": 0,
    },
